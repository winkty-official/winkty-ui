...
export const MainAppTrayExample = () => {
  const icons = [
    {
      id: "settings",
      name: "Settings",
  ...
  return (
    <div className="relative min-h-[400px] bg-gradient-to-br from-gray-900 to-gray-800">
      <AppTray>
        {icons?.map((icon) => <AppTrayIcon key={icon.id} {...icon} />)}
      </AppTray>
      <AppWindowContainer>
        {icons?.map((icon) => (
          <AppWindow
