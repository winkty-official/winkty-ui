export const packageInfo = {
  pkg: {
    name: "@yourlibrary/particle-field",
    dependencies: ["framer-motion"],
  },
  cli: {
    command:
      "npx shadcn-ui@latest add https://your-domain.com/registry/particle-field.json",
  },
  manual: {
    pkg: {
      dependencies: ["framer-motion"],
...
export const ParticleField = ({
  ...
  return (
    ...
    >
      ...
      {
        name: "index.ts",
        code: `export { ParticleField } from "./particle-field";
