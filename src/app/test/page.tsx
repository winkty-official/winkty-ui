...
function App() {
  ...
  const icons = [
    ...
    { id: 'trash', name: 'Telegram', icon: <Image src={trash} alt='trash' width={50} height={50} className="h-full w-full text-neutral-500 dark:text-neutral-300" /> },
  ];
